...
for test=1:1:n_test
    ...
    for repeat_test=1:1000 
        ...
        [Sum_Out_DTPC,Out_prob_DTPC,Throughput_DTPC,P_DTPC,Gamma_DTPC]= DTPC(gamahat_vector,eta_vector,BG_Noise,initial_power,H,dontshow);
        [Sum_Out_OPC,Out_prob_OPC,Throughput_OPC,P_OPC,Gamma_OPC]= Unconstrained_OPC(gamahat_vector,eta_vector,BG_Noise,initial_power,H,dontshow); 
        [Sum_Out_TPC,Out_prob_TPC,Throughput_TPC,P_TPC,Gamma_TPC]= Unconstrained_TPC(gamahat_vector,BG_Noise,initial_power,H,dontshow);
